...
RUN go mod download; go build -ldflags "-w -s -X 'main.GitCommit=$GIT_COMMIT'" -tags 'osusergo netgo' -o /build/client client.go fixed.go forwardingConf.go commons.go game.go game_fixed.go
